...
public class PredictMultiClass {
	private static final Logger LOG = Logger.getLogger(PredictMultiClass.class);
	...
	public static void main(String[] args) throws IOException,
		...
		if (!cmdline.hasOption(OUTPUT_OPTION)
			...
			formatter.printHelp(PredictMultiClass.class.getCanonicalName(),
					options);
			System.exit(-1);
		}

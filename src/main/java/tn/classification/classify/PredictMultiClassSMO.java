...
public class PredictMultiClassSMO {
	private static final Logger LOG = Logger.getLogger(PredictMultiClassSMO.class);
...
//				tree.buildClassifier(trainInstances);
				...
				for (int i = 0; i < testInstances.numInstances(); i++) {
					double j48Pred = smo.classifyInstance(testInstances
							.instance(i));

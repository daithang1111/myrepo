...
do
	...
	python topic_interpretability/ComputeObservedCoherence.py /cliphomes/daithang/TEST_WB/20news.mallet.$K.topics.norm $metric /fs/clip-scratch/daithang/word_count/20news/20news_dev_raw.wc > /cliphomes/daithang/TEST_WB/20news.mallet.$K.oc
